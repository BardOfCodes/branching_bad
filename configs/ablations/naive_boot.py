...
class NaiveBootConfFactory(CNF):
    ...
    def __init__(self, name="NaiveBOOT_2", machine="local"):
        ...
        config.ABSTRACTION.DELETE_THRESHOLD = 0.01
        ...
        config.ABSTRACTION.CS_SPLICER.MAX_NEW_PERCENTAGE = 0.5# 0.5
        config.ABSTRACTION.CS_SPLICER.LENGTH_FACTOR = 0.25
        
        config.OBJECTIVE.NOVEL_CMD_WEIGHT = 5
        
        config.MODEL.RELOAD_ON_DSL_UPDATE = 0
