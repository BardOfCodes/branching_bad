...
class CSG2DExecutor:
    ...
    def compile(self, expression):
        ...
        draw_transforms, inversion_array, intersection_matrix = self.compiler.fast_compile(parsed_graphs, draw_count)
    ...
    def execute(self, draw_transforms, inversion_array, intersection_matrix):
        ...
        canvas = self.compiler.evaluate(draw_transforms, inversion_array, intersection_matrix)
        return canvas